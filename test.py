...
# بارگذاری تصویر
try:
    img1 = pygame.transform.scale(pygame.image.load("New folder/01.png"),[125 , 125])
    img1 = img1.convert()
    rect1 = img1.get_rect()
    rect1.topleft = (100, 350)


    img2 = pygame.transform.scale(pygame.image.load("New folder/02.png") ,[125 , 125])
    img2 = img2.convert()
    rect2 = img2.get_rect()
    rect2.bottomright = (370 , 473)

    img3 = pygame.transform.scale(pygame.image.load("New folder/03.png") , [125 , 125])
    img3 = img3.convert()
    rect3 = img3.get_rect()
    rect3.center = (500 , 4)
